...
public class Muco extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muco);
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("plant.tflite");
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(this,"la.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        for (Map.Entry<String, Float> entry : labeledProbability.entrySet()) {
            if (entry.getValue()==maxValueInMap) {
                ...
                if(z.contentEquals("BLIGHT")){
                    link01.setText("LINK1");
                    link02.setText("LINK2");
                }
            }
        }
    }
